...
Each translated element uses independently configured translation and menu shortcuts:
...
- pressing the translation shortcut on an already translated source restores the original;
- pressing the menu shortcut opens the language control.
