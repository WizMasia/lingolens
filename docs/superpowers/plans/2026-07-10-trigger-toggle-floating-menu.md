...
- [ ] **Step 1: Write failing trigger-classification tests**
...
- [ ] **Step 3: Implement normalized Alt-trigger matching**
...
- [ ] **Step 4: Route content events by action**
...
- [ ] **Step 5: Verify entry behavior tests**
...
- [ ] **Step 3: Restore on repeated primary action**
...
- [ ] **Step 4: Verify focused controller tests**
...
- [ ] **Step 1: Write failing menu placement and dismissal tests**
...
- [ ] **Step 4: Verify focused menu tests**
