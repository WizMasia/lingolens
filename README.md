...
- Press the trigger again on an already translated element, or use its language action, to select an explicit source and target language and translate it again.
